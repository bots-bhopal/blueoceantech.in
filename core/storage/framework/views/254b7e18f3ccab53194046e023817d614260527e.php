                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="slink" class="form-horizontal" action="<?php echo e(route('admin.updateSlinks', $slink->id)); ?>" method="POST" onsubmit="store(event)">
                            ...
                            <div class="form-group row">
                                <label for="target" class="col-sm-2 control-label"><?php echo e(__('Status')); ?><span class="text-danger">*</span></label>

                                <div class="col-sm-10">
                                    <select class="form-control" name="target">
                                       <option value=""><?php echo e(__('----- Select Target -----')); ?></option>
                                       <option value="_blank" <?php echo e($slink->target == '_blank' ? 'selected' : ''); ?>><?php echo e(__('_blank')); ?></option>
                                       <option value="_self" <?php echo e($slink->target == '_self' ? 'selected' : ''); ?>><?php echo e(__('_self')); ?></option>
                                      </select>
                                    <?php if($errors->has('target')): ?>
                                        <p class="text-danger"> <?php echo e($errors->first('target')); ?> </p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="form-group row">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\blueoceantech.in\core\resources\views/admin/settings/social/edit.blade.php ENDPATH**/ ?>