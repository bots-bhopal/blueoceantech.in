                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.bcategory.update', $bcategory->id)); ?>" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="serial_number" placeholder="<?php echo e(__('Order')); ?>" value="<?php echo e($bcategory->serial_number); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\blueoceantech.in\core\resources\views/admin/blog/blog-category/edit.blade.php ENDPATH**/ ?>