                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <form id="slink" class="form-horizontal" action="<?php echo e(route('admin.storeSlinks')); ?>" method="POST" onsubmit="store(event)">
                            ...
                            <div class="form-group row">
                                <label for="target" class="col-sm-2 control-label"><?php echo e(__('Target')); ?><span
                                    class="text-danger">*</span></label>
            
                                <div class="col-sm-10">
                                  <select class="form-control" name="target">
                                    <option value=""><?php echo e(__('----- Select Target -----')); ?></option>
                                    <option value="_blank"><?php echo e(__('_blank')); ?></option>
                                    <option value="_self"><?php echo e(__('_self')); ?></option>
                                  </select>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\blueoceantech.in\core\resources\views/admin/settings/social/index.blade.php ENDPATH**/ ?>