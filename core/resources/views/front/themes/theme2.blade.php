            ...
            <div class="col-lg-6 col-md-12 order-1 order-lg-2">
                <div class="about-item mt-30">
                    ...
                    <div class="text-justify">
                        ...
                        {{-- <p class="text-justify">{!! (strlen(strip_tags(Helper::convertUtf8($sinfo->about_text))) > 1080) ? substr(strip_tags(Helper::convertUtf8($sinfo->about_text)), 0, 1080) . '...' : strip_tags(Helper::convertUtf8($sinfo->about_text)) !!}</p> --}}
                    </div>
                    {{-- <p>{{ $sinfo->about_text }}</p> --}}
            ...
            <div class="col-lg-4">
                <div class="leadership-item mt-30">
                    ...
                    <div class="leadership-content">
                        <a href="#team-area" class="d-block"><h5 class="title">{{ $item->name }}</h5></a>
